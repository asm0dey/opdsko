...
open class BookRecord private constructor() : UpdatableRecordImpl<BookRecord>(Book.BOOK), IBook {
    ...
    open override var sequenceNumber: Int?
     ...
     */
    constructor(id: Long?, path: String, name: String, date: String?, added: LocalDateTime?, sequence: String?, sequenceNumber: Int?, lang: String?, zipFile: String?, seqid: Int?): this() {
        this.id = id
        this.path = path
        this.name = name
        this.date = date
     ...
     * Create a detached, initialised BookRecord
     */
    constructor(value: io.github.asm0dey.opdsko.jooq.tables.pojos.Book?): this() {
        if (value != null) {
            this.id = value.id
